...
from serdes_python_api.pcie6_v2.pcie6_v2 import PCIE6_V2

REVISION = '$Revision: #2 $'
DATE = '$Date: 2024/01/09 $'


def tx_eq_sweep(evb: PCIE6_V2,
                lane: int,
                repetitions: int = 2,
                pause: float = 0.25,
                cm2_lo: int = 0,
...
def tx_eq_sweep_fixed(evb: PCIE6_V2,
                      lane: int,
                      repetitions: int = 2,
                      pause: float = 0.25,
                      cm2_lo: int = 0,
...
def tx_eq_sweep_preset(evb: PCIE6_V2, lane: int, repetitions: int = 5, pause: float = 0.25, presets:
...
def tx_eq_sweep_custom(evb: PCIE6_V2, lane: int, cursors: list[dict], repetitions: int = 2,
                       pause: float = 0.25):
