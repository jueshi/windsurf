...
from serdes_python_api.pcie6.pcie6 import PCIE6

REVISION = '$Revision: #2 $'
DATE = '$Date: 2024/05/10 $'


def tx_eq_sweep(evb: PCIE6,
                lane: int,
                repetitions: int = 2,
                pause: float = 0.25,
                cm2_lo: int = 0,
...
def tx_eq_sweep_fixed(evb: PCIE6,
                      lane: int,
                      repetitions: int = 2,
                      pause: float = 0.25,
                      cm2_lo: int = 0,
...
def tx_eq_sweep_preset(evb: PCIE6, lane: int, repetitions: int = 5, pause: float = 0.25, presets:
...
def tx_eq_sweep_custom(evb: PCIE6, lane: int, cursors: list[dict], repetitions: int = 2,
                       pause: float = 0.25):
